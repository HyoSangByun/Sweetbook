...
public class ActivityController {
    ...
    public ResponseEntity<ApiResponse<ActivityImportResponse>> importCsv(
        ...
        return ResponseEntity.ok(ApiResponse.ok(activityCsvImportService.importCsv(file)));
    }
    ...
    public ResponseEntity<ApiResponse<List<ActivityMonthResponse>>> getMonths() {
        return ResponseEntity.ok(ApiResponse.ok(activityService.getMonths()));
    }
    ...
    public ResponseEntity<ApiResponse<List<ActivitySummaryResponse>>> getActivitiesByMonth(
        ...
        return ResponseEntity.ok(ApiResponse.ok(activityService.getActivitiesByMonth(month)));
    }
    ...
    public ResponseEntity<ApiResponse<ActivityDetailResponse>> getActivityDetail(
        ...
        return ResponseEntity.ok(ApiResponse.ok(activityService.getActivityDetail(activityId)));
    }
    ...
    public ResponseEntity<ApiResponse<ActivityStatsResponse>> getMonthlyStats(
        ...
        return ResponseEntity.ok(ApiResponse.ok(activityService.getMonthlyStats(month)));
    }
}
